    ...
    <nav>
        <ul class="c-pagination">
            ...
            @if ($paginator->onFirstPage())
                <li class="c-pagination__item is-disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                    <li class="c-pagination__item is-disabled" aria-disabled="true"><span class="c-pagination__link">{{ $element }}</span></li>
                @endif
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="c-pagination__item is-active" aria-current="page"><span class="c-pagination__link">{{ $page }}</span></li>
                        @else
            ...
            @else
                <li class="c-pagination__item is-disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
